"""
Data update coordinator package for nordpool_allin.
...
Package structure:
- base.py: Main coordinator class (NordpoolAllinDataUpdateCoordinator)
...
from .base import NordpoolAllinDataUpdateCoordinator

__all__ = ["NordpoolAllinDataUpdateCoordinator"]
