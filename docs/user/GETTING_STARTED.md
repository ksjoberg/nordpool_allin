# Getting Started with NordPool All-In

This guide will help you install and set up the NordPool All-In custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/ksjoberg/nordpool_allin`
6. Set category to "Integration"
7. Click "Add"
8. Find "NordPool All-In" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/ksjoberg/nordpool_allin/releases)
...
4. Select entities from "NordPool All-In"
...
- Report issues at [GitHub Issues](https://github.com/ksjoberg/nordpool_allin/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/ksjoberg/nordpool_allin/discussions)
