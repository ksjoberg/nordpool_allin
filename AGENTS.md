...
- **Repository:** ksjoberg/nordpool_allin

**Key directories:**

- `custom_components/nordpool_allin/` - Main integration code
...
- Integration logs: `custom_components.nordpool_allin: debug` in `config/configuration.yaml`
...
- **Domain:** `nordpool_allin`
- **Title:** NordPool All-In
- **Class prefix:** `NordpoolAllin`

**When creating new files:**

- Use the domain `nordpool_allin` for all DOMAIN references
- Prefix all integration-specific classes with `NordpoolAllin`
- Use "NordPool All-In" as the display title
...
- Inherit from platform base + `NordpoolAllinEntity`
...
- `tests/` mirrors `custom_components/nordpool_allin/` structure
